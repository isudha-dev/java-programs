package concepts.accessmodifier.secondpkg;

import concepts.accessmodifier.firstpkg.Parent;
...
public class Another {
    public static void staticMethod() {
        ...
        System.out.println("Protected parent " + "not accessible Parent.p_st_prtcd_attr"); // was accessible in child class
    }
    ...
    public void nonStaticMethod(){
        ...
        System.out.println("Protected parent " + "not accessible p.p_prtcd_attr"); // was accessible in child class
    }
}
